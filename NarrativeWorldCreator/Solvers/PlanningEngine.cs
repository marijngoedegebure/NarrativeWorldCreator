...
namespace NarrativeWorldCreator.Solvers
{
    public static class PlanningEngine
    {
        ...
        public static Vector3 GetPossibleLocationsBasic(LocationNode node, NarrativeTimePoint ntp)
        {
        ...
        public static Polygon ReduceBaseShapeWithObjects(LocationNode node, NarrativeTimePoint ntp)
        {
